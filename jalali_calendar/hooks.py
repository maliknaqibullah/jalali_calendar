...
app_include_css = [
                "/assets/jalali_calendar/hijri_libary/jquery.calendars.picker.css",
                "/assets/jalali_calendar/css/islamic_calendar.css"]
app_include_js = [
                "islamic_assets.bundle.js"
                ]

boot_session = "jalali_calendar.jalali_calendar.islamic_configure.boot_session"
extend_bootinfo = [
    "jalali_calendar.jalali_calendar.islamic_configure.bootinfo",
]
